...
**Стратегический разворот (2026-05-15 ~22:20 MSK):** Off-by-one и склейка ответов не устранились ни skill v2.1, ни watchdog, ни сбросом сессии. Бот склеивает ответы в новой сессии с 10 строками и без skill. Принято решение: откатить Memoh-core к `c1afe432`, убрать `studio_event_mirror.go`, удалить старую память, и строить всё только нативными средствами Memoh (system prompt, skill, MCP, настройки UI). Больше в Memoh-core не лезем.
