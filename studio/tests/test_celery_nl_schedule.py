...
def test_celery_beat_never_schedules_nl_processor(monkeypatch: pytest.MonkeyPatch) -> None:
    """NL worker removed from beat: Memoh owns replies; legacy task may still exist on workers."""
